...
| T2 / TASK-002 | Apply project-scoped Synapse state to search with invalid/unscoped fallbacks | CMT-01 | T1 | Focused search/Synapse unit + upgraded F24 | `feat(search): apply Synapse state to project search` |
