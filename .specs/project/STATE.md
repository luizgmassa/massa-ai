...
- feature: `sensor-repair-2026-07` — **Specified 2026-07-28. All five decisions closed by the
  spec owner. Tasks not yet written; no branch, no worktree, no commits.**
- base: `origin/main` @ `a6216cd` (v1.9.0)
- Artifacts: `.specs/features/sensor-repair-2026-07/spec.md`
