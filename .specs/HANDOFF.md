...
## Active — Model Profile Switching (spec-driven, VALIDATED PASS 2026-08-04; PR #69 open, merge = user decision)
...
## Previous — persona-router-token-optimization (T0–T9 COMPLETE, validated PASS; PR #68 open, CI 14/14 green; merge = user's decision)
