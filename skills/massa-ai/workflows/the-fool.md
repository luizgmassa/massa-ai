...
8. Dispatch the full critique:
   ...
   - Use the `plan-critic` contract and capability-packet shape from `references/agent-orchestration.md`; dispatch under `plan-critic`.
