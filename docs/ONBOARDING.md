...
| **Agent-harness surface** | `skills/AGENTS.md`, `CLAUDE.md` | 16 sub-agent specialists, 4 plugin hosts, generated artifacts with parity tests. `apps/*-plugin/skills/` are byte-identical generated copies — never edit them directly, edit `skills/` and regenerate. |
