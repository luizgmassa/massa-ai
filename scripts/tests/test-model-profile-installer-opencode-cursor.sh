...
# apps/opencode-plugin/agent-profiles/work/senior-engineer.md in place (to
...
WORK_VARIANT_BAK=""
WORK_VARIANT="$PROJECT_ROOT/apps/opencode-plugin/agent-profiles/work/senior-engineer.md"
...
# REAL, checked-in apps/opencode-plugin/agent-profiles/work/senior-engineer.md
...
DEFAULT_ACTIVE="$PROJECT_ROOT/apps/opencode-plugin/agents/senior-engineer.md"
...
LINK="$H/.config/opencode/agents/senior-engineer.md"
...
assert_eq "opencode symlink target is the materialized work variant" \
  "$TARGET_PATH" "$H/.config/opencode/plugins/massa-ai/agent-profiles/work/senior-engineer.md"
...
assert_file "opencode variant tree: balanced/senior-engineer.md materialized" "$VARIANT_DEST/balanced/senior-engineer.md"
assert_file "opencode variant tree: work/senior-engineer.md materialized" "$VARIANT_DEST/work/senior-engineer.md"
if cmp -s "$VARIANT_DEST/work/senior-engineer.md" "$WORK_VARIANT"; then
...
WORK_MATERIALIZED="$H/.config/opencode/plugins/massa-ai/agent-profiles/work/senior-engineer.md"
...
NEW_WORK_MATERIALIZED="$H/.config/opencode/plugins/massa-ai/agent-profiles/work/senior-engineer.md"
