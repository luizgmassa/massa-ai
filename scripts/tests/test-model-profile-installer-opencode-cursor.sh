...
# apps/opencode-plugin/agent-profiles/work/builder.md in place (to
...
WORK_VARIANT_BAK=""
WORK_VARIANT="$PROJECT_ROOT/apps/opencode-plugin/agent-profiles/work/builder.md"
...
# REAL, checked-in apps/opencode-plugin/agent-profiles/work/builder.md
...
DEFAULT_ACTIVE="$PROJECT_ROOT/apps/opencode-plugin/agents/builder.md"
...
LINK="$H/.config/opencode/agents/builder.md"
...
assert_eq "opencode symlink target is the materialized work variant" \
  "$TARGET_PATH" "$H/.config/opencode/plugins/massa-ai/agent-profiles/work/builder.md"
...
assert_file "opencode variant tree: balanced/builder.md materialized" "$VARIANT_DEST/balanced/builder.md"
assert_file "opencode variant tree: work/builder.md materialized" "$VARIANT_DEST/work/builder.md"
if cmp -s "$VARIANT_DEST/work/builder.md" "$WORK_VARIANT"; then
...
WORK_MATERIALIZED="$H/.config/opencode/plugins/massa-ai/agent-profiles/work/builder.md"
...
NEW_WORK_MATERIALIZED="$H/.config/opencode/plugins/massa-ai/agent-profiles/work/builder.md"
