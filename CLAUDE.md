...
`skills/AGENTS.md` is the registry for the 15 sub-agent specialists **and** the single
...
`synapse-usage` skills were folded into those two references and deleted. `apps/{claude,codex,cursor,opencode}-plugin/` ship those same 15
