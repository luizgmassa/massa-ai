...
Plus 36 generated workflow commands, one per massa-ai workflow (`$debug`, etc.) — see [Workflow Commands](../../FEATURES.md#workflow-commands-generated-slash-commands) in the root feature reference for the full naming table.
